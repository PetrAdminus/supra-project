...
module lottery::operators_tests {
    ...
    fun admin_assigns_and_grants(
        ...
        let snapshot_owner = test_utils::unwrap(snapshot_owner_opt);
        ...
        let owner_after_grant = test_utils::unwrap(owner_after_grant_opt);
        ...
        let initial_owner = test_utils::unwrap(initial_owner_opt);
        ...
        let grant_owner = test_utils::unwrap(grant_owner_opt);
    ...
    fun owner_can_manage(
        ...
        let owner_after_revoke = test_utils::unwrap(owner_after_revoke_opt);
        ...
        let revoke_owner = test_utils::unwrap(revoke_owner_opt);
