...
module lottery::operators_tests {
    ...
    fun admin_assigns_and_grants(
        ...
        let mut owner_opt = operators::get_owner(0);
        ...
        let (mut snapshot_owner_opt, snapshot_operators) =
        ...
        let mut operators_list_opt = operators::list_operators(0);
        ...
        let (mut owner_after_grant_opt, operators_after_grant) =
        ...
        let (grant_lottery, mut grant_owner_opt, grant_operators) =
    ...
    fun owner_can_manage(
        ...
        let mut operators_after_opt = operators::list_operators(7);
        ...
        let (mut owner_after_revoke_opt, operators_after_revoke) =
        ...
        let (revoke_lottery, mut revoke_owner_opt, revoke_operators) =
