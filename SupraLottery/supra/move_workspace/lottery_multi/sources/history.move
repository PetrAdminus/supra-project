...
module lottery_multi::history {
    ...
    pub const EVENT_CATEGORY_REFUND: u8 = 8;
    ...
    pub struct LotteryCanceledEvent has drop, store {
        pub event_version: u16,
        pub event_category: u8,
        pub lottery_id: u64,
    ...
    pub struct RefundBatchEvent has drop, store {
        pub event_version: u16,
        pub event_category: u8,
        pub lottery_id: u64,
        ...
        pub total_tickets_refunded: u64,
