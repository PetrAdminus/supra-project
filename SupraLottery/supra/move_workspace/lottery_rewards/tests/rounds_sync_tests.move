...
module lottery_rewards::rounds_sync_tests {
    ...
    fun syncs_purchase_queue_into_rewards(
        ...
        // Очистка событий перед основной проверкой синхронизации.
        ...
        test_utils::assert_len_eq<vip::VipBonusIssuedEvent>(&bonus_events, 1, 200);
        ...
        test_utils::assert_len_eq<vip::VipSnapshotUpdatedEvent>(&vip_snapshot_events, 1, 204);
        ...
        test_utils::assert_len_eq<referrals::ReferralRewardPaidEvent>(
            &referral_reward_events,
            1,
            220,
        );
        let referrals::ReferralRewardPaidEvent {
            lottery_id: reward_lottery,
            buyer: reward_buyer,
            referrer: reward_referrer,
            referrer_amount,
            referee_amount,
            total_amount,
        } = *test_utils::last_event_ref(&referral_reward_events);
