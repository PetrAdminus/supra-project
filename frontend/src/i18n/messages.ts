...
const en = {
  ...
  admin: {
    ...
    plan: {
      ...
      items: {
        first: "Run the dVRF subscription flow (add_client_to_whitelist, deposit_fund, configure_vrf_request).",
...
const ru: Messages = {
  ...
  admin: {
    ...
    plan: {
      ...
      items: {
        first: "Пройти сценарий dVRF (add_client_to_whitelist, deposit_fund, configure_vrf_request).",
    ...
    treasury: {
      ...
      controls: {
        ...
        balances: {
          jackpot: "?????? ????????: {{value}} SUPRA",
          prize: "?????? ???????? ?????: {{value}} SUPRA",
          treasury: "?????? ????????????: {{value}} SUPRA",
          marketing: "?????? ??????????: {{value}} SUPRA",
        },
      },
    },
    common: {
