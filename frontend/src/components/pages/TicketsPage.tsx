      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <Card className="glass-strong p-8 rounded-2xl border-cyan-500/30 glow-cyan mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Button
              className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white px-8 py-6 text-lg rounded-xl glow-cyan transition-all disabled:cursor-not-allowed disabled:opacity-60"
              disabled={!selectedLottery || isSupraMode}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {error && (
            <Card className="glass-strong p-6 rounded-2xl border-pink-500/30 text-pink-200 col-span-full">
              Failed to load ticket history. Please try again later.
            </Card>
          )}
          {isLoading && !filteredTickets.length && !error && (
            <Card className="glass-strong p-6 rounded-2xl border-cyan-500/20 text-cyan-200 col-span-full">
              Loading your tickets...
            </Card>
          )}
          {!isLoading && !error && filteredTickets.length === 0 && (
            <Card className="glass-strong p-6 rounded-2xl border-cyan-500/20 text-gray-300 col-span-full">
              You have no tickets yet. Purchase one to enter the next draw.
            </Card>
          )}
