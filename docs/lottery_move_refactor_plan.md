...
- [x] **Этап 2. Общие утилиты и арифметика.**
...
- [ ] **Этап 3. Рефакторинг снапшотов и заимствований.**
  ...
  - ✅ `Store.move` переведён на новые снапшоты и события (`events::emit`, `math::*`).
...
4. Перевести первые модули (`Metadata`, `History`, `Autopurchase`) на новые снапшоты и события без `borrow::freeze` и `math64`. ✅
