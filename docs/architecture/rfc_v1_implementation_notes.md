...
| 1    | Фундаментальные артефакты: схемы ресурсов, событий, view и документации        | In Progress        | Расширены `types`, `registry`, `views`, добавлены `economics`, `feature_switch`, стартовал модуль `sales` | 2025-11-08 |
