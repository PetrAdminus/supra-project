...
| `history` | Архивы, dual-write, снапшоты | In Progress | Развернут `ArchiveLedger`, события финализации, `record_summary` и пагинация архива | 2025-11-09 |
| `views` | Публичные API, фильтры, JSON-схемы | In Progress | Реализованы фильтры по типам и тегам, выдача бейджей, доступ к архивным summary и спискам финализированных ID | 2025-11-09 |
