...
| 1    | Фундаментальные артефакты: схемы ресурсов, событий, view и документации        | In Progress        | Расширены `types`, `registry`, `views`, добавлены `economics`, `feature_switch`, `sales`, запущен `draw` с VRF-событиями | 2025-11-08 |
...
| `sales` | Выпуск билетов, лимиты, анти-DoS | In Progress | Реализованы события `TicketPurchase`, хранение чанков и лимиты на покупку | 2025-11-08 |
| `draw` | VRF-запросы, обработка retry, анти-bias | In Progress | Создан ledger запросов, события `VrfRequested/VrfFulfilled`, хэш снапшота билетов | 2025-11-08 |
