...
| 1    | Фундаментальные артефакты: схемы ресурсов, событий, view и документации        | In Progress        | Созданы базовые модули `tags`, `roles`, `registry`, `views`, `feature_switch` | 2025-11-08 |
