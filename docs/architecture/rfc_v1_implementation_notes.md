...
| 1    | Фундаментальные артефакты: схемы ресурсов, событий, view и документации        | Not Started                                   |                      | _YYYY-MM-DD_ |
...
|--------|----------------------|-------------------|---------------|------------------|
| `registry` | Жизненный цикл лотерей, статусы, идентификаторы | Not Started |  | _YYYY-MM-DD_ |
| `sales` | Выпуск билетов, лимиты, анти-DoS | Not Started |  | _YYYY-MM-DD_ |
| `draw` | VRF-запросы, обработка retry, анти-bias | Not Started |  | _YYYY-MM-DD_ |
| `payouts` | Подсчёт победителей, батчи выплат, идемпотентность | Not Started |  | _YYYY-MM-DD_ |
| `economics` | Резервы, распределение долей, джекпот | Not Started |  | _YYYY-MM-DD_ |
| `history` | Архивы, dual-write, снапшоты | Not Started |  | _YYYY-MM-DD_ |
| `views` | Публичные API, фильтры, JSON-схемы | Not Started |  | _YYYY-MM-DD_ |
| `roles` | Capabilities, партнёры, премиальные подписки | Not Started |  | _YYYY-MM-DD_ |
| `tags` | Классификаторы, фильтрация, маски | Not Started |  | _YYYY-MM-DD_ |
| `price_feed` | Оракулы SUPRA/USD и прочие активы | Not Started |  | _YYYY-MM-DD_ |
| `feature_switch` | Управление доступом к функциям | Not Started |  | _YYYY-MM-DD_ |
