...
| `sales` | Выпуск билетов, лимиты, анти-DoS | In Progress | Реализованы события `TicketPurchase`, хранение чанков, выдача владельца билета через `ticket_owner`, учёт `SalesDistribution` и агрегатов `accounting` | 2025-11-08 |
