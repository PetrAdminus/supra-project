...
- **Этап 4 — миграция и backfill.**
  ...
  - ✅ (2025-11-25) Добавлены Move-тесты `history_migration_tests` и CLI `supra/scripts/history_backfill.sh`, покрывающие импорт, откат и ручное назначение тегов.
...
- **Этап 5 — запуск ядра под управлением администратора.**
  ...
  - ✅ (2025-11-30) Автоматизирован журнал операций: CLI `supra/scripts/incident_log.sh`, Python-модуль `supra.tools.incident_log`, обновлены runbook, release checklist и инструкции с примерами.
