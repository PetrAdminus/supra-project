...
- Дополнительно `payouts_tests::payout_handles_multi_slot_plan` валидирует распределение выигрышей для многослотной конфигурации, а `payouts_tests::partner_payout_cannot_exceed_cap` фиксирует ошибку `E_PARTNER_PAYOUT_BUDGET_EXCEEDED` при превышении остатка партнёрского бюджета; `partner_payout_updates_operations` отслеживает уменьшение `remaining_payout` после успешного транша.
...
- Примеры вызовов и сценариев приведены в [../operations/runbooks.md](../operations/runbooks.md), [../operations/release_checklist.md](../operations/release_checklist.md), [../operations/monitoring.md](../operations/monitoring.md) и [../frontend/overview.md](../frontend/overview.md).
- Операционные заметки и программа безопасности доступны в [../operations/incident_log.md](../operations/incident_log.md) и [../operations/bug_bounty.md](../operations/bug_bounty.md).
