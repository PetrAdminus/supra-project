...
Р­С‚РѕС‚ РґРѕРєСѓРјРµРЅС‚ РѕРїРёСЃС‹РІР°РµС‚ РјРёРЅРёРјР°Р»СЊРЅСѓСЋ РєРѕРЅС„РёРіСѓСЂР°С†РёСЋ РїСѓР±Р»РёС‡РЅРѕР№ СЃС‚Р°С‚СѓСЃРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ РґР»СЏ `lottery_multi` Рё СЃРІСЏР·С‹РІР°РµС‚ РѕРЅС‡РµР№РЅ-РјРµС‚СЂРёРєРё СЃ РѕРїРµСЂР°С†РёРѕРЅРЅС‹РјРё РёРЅРґРёРєР°С‚РѕСЂР°РјРё. РћСЃРЅРѕРІРѕР№ СЃР»СѓР¶Р°С‚ view-С„СѓРЅРєС†РёРё [`lottery_multi::views::status_overview`](../architecture/json/lottery_multi_views.schema.json), РІРѕР·РІСЂР°С‰Р°СЋС‰Р°СЏ Р°РіСЂРµРіРёСЂРѕРІР°РЅРЅС‹Рµ СЃС‡С‘С‚С‡РёРєРё РїРѕ СЃС‚Р°С‚СѓСЃР°Рј Р»РѕС‚РµСЂРµР№, VRF Рё Р±СЌРєР»РѕРіСѓ РІС‹РїР»Р°С‚, Рё [`lottery_multi::views::list_automation_bots`](../architecture/json/lottery_multi_views.schema.json), СЂР°СЃРєСЂС‹РІР°СЋС‰Р°СЏ С‚РµРєСѓС‰РµРµ СЃРѕСЃС‚РѕСЏРЅРёРµ AutomationBot (С‚Р°Р№РјР»РѕРєРё, pending-РґРµР№СЃС‚РІРёСЏ, Р»РёРјРёС‚С‹ `max_failures`).
...
| РџРѕР»Рµ `list_automation_bots` | РќР°Р·РЅР°С‡РµРЅРёРµ | РџРѕСЂРѕРі/Р°Р»РµСЂС‚ | Р”РµР№СЃС‚РІРёСЏ |
|-----------------------------|------------|-------------|----------|
...
1. Р’С‹Р·РІР°С‚СЊ view СЃРѕ СЃРІРѕРґРєРѕР№ СЃС‚Р°С‚СѓСЃРѕРІ:
   ...
   supra move view \
     ...
     --args u64:$(date +%s)
   ```
2. РџРѕР»СѓС‡РёС‚СЊ СЃРѕСЃС‚РѕСЏРЅРёРµ AutomationBot (РїСЂРё СЂСѓС‡РЅРѕРј Р·Р°РїСѓСЃРєРµ РјРѕР¶РЅРѕ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ РѕР±С‘СЂС‚РєСѓ `./SupraLottery/supra/scripts/automation_status.sh`):
   ```bash
   ...
   ```
3. РџСЂРµРѕР±СЂР°Р·РѕРІР°С‚СЊ РѕС‚РІРµС‚С‹ РІ JSON Рё РїРµСЂРµРґР°С‚СЊ РІ РІРёРґР¶РµС‚С‹ СЃС‚Р°С‚СѓСЃРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ (`status_overview` в†’ Р±Р»РѕРєРё СЃРѕ СЃС‡С‘С‚С‡РёРєР°РјРё, `list_automation_bots` в†’ С‚Р°Р±Р»РёС†Р° Р±РѕС‚Р°).
...
- Р”РѕР±Р°РІРёС‚СЊ РґР°С€Р±РѕСЂРґ Grafana В«Lottery Multi StatusВ» СЃ РІРёР·СѓР°Р»РёР·Р°С†РёСЏРјРё РїРѕ РєР°Р¶РґРѕРјСѓ РїРѕР»СЋ `status_overview` Рё С‚Р°Р±Р»РёС†РµР№ `list_automation_bots` (РѕРїРµСЂР°С‚РѕСЂ, pending, Р»РёРјРёС‚ РѕС€РёР±РѕРє).
...
- РџРµСЂРµРґ Р·Р°РїСѓСЃРєРѕРј РЅРѕРІРѕР№ РІРµСЂСЃРёРё СѓР±РµРґРёС‚СЊСЃСЏ, С‡С‚Рѕ `status_overview` Рё `list_automation_bots` РІРѕР·РІСЂР°С‰Р°СЋС‚ РєРѕСЂСЂРµРєС‚РЅС‹Рµ Р·РЅР°С‡РµРЅРёСЏ РЅР° devnet/staging.
