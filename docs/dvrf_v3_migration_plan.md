...
- [x] Проверить Python-скрипты и CLI-утилиты, использующие старые функции. Итог: скрипты мониторинга и миграции (`supra/scripts`) уже ссылались на camelCase API, изменений не потребовалось.
